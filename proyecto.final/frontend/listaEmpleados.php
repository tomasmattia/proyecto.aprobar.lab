...
<html lang="en">
  ...
  <body>
    <div class="container-fluid" id="laTabla">
      <h2 class="display-4 text-center">Listado de Empleados</h2>
      <div class="row justify-content-center mb-3">
      <a href="./listaCamisetas.php"><button type="button" class="btn btn-warning">Ver lista de Camisetas</button></a>
