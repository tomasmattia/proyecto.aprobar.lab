            ...
            <div class="card" style="width: 40rem;">
                <div class="card-body bg-secondary">
                    <form class="form-horizontal" role="form" id='formulario'>
                        <label for="ejemplo_password_3" class="control-label"></label><h6 class="card-subtitle mb-2 text-light">Usuario</h6>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="clave" placeholder="Username">
                        </div>
                        <label for="ejemplo_password_3" class="control-label"></label><h6 class="card-subtitle mb-2 text-light">Email</h6>
                        <div class="input-group mb-2">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="legajo" placeholder="Username">
                        </div>
